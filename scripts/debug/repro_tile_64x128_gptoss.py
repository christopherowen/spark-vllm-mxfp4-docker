#!/usr/bin/env python3
"""
Repro: SM120/121 MoE tile_mn=(64,128) (non-swap) behavior on gpt-oss-like dims.
...
Run inside vllm-dev:
  ...
  python3 /workspace/scripts/debug/repro_tile_64x128_gptoss.py
"""
...
def main() -> int:
    ...
    tile_mn = (64, 128)  # known-good (non-swap) tile
